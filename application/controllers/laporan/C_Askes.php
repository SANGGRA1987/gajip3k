    ...
    public function askes(){
       ...
       if (isset($_POST['kd_skpd1'])) {
            ...
            $cRet .="<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"1\" cellpadding=\"1\">
                    ...
                    <tr>
                        <td align=\"center\" style=\"font-size:12px;border: solid 1px white;\">HASIL PEMUNGUTAN IURAN BPJS KESEHATAN PEGAWAI NEGERI SIPIL DAERAH</td>
                    </tr>
                    ";
                    $cRet.="</table>";
            $cRet .="<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"1\" cellpadding=\"1\">
             ...
             $cRet .="<table style=\"border-collapse:collapse; border-color: black;\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"1\" cellpadding=\"1\" >
                    ...
                    <tr>
                        ...
                        <td align=\"center\" width=\"35%\" style=\"font-size:12px;border-left:dashed 1px gray;border-right:dashed 1px gray;border-bottom:dashed 1px gray;border-top:dashed 1px gray\" >NAMA DINAS / INSTANSI SATKER</td>
                        ...
                        <td align=\"center\" width=\"10%\" style=\"font-size:12px;border-left:dashed 1px gray;border-right:dashed 1px gray;border-bottom:dashed 1px gray;border-top:dashed 1px gray\" >JUMLAH TUNJANGAN KELUARGA</td>
                        ...
                        <td align=\"center\" width=\"10%\" style=\"font-size:12px;border-left:dashed 1px gray;border-right:dashed 1px gray;border-bottom:dashed 1px gray;border-top:dashed 1px gray\" >JUMLAH IURAN BPJS KESEHATAN</td>
                    ...
                    <tr>
                        ...
                        <td align=\"center\" width=\"35%\" style=\"font-size:12px;border-left:dashed 1px gray;border-right:dashed 1px gray;border-bottom:dashed 1px gray;border-top:dashed 1px gray\" >2</td>
                        ...
                        <td align=\"center\" width=\"10%\" style=\"font-size:12px;border-left:dashed 1px gray;border-right:dashed 1px gray;border-bottom:dashed 1px gray;border-top:dashed 1px gray\" >8</td>
                    </tr>
                    </thead>"; 
                    ...
                    $sql = "SELECT a.satkerja,a.nm_satkerja,
                        ...
                        (select sum(askes) as askes from pegawai d where d.satkerja=a.satkerja) as askes
                    ...
                    foreach ($tunjangan as $row){
                        ...
                        $t_kel1 = number_format($t_kel ,2,',','.');
                        $jumlah = $row->jumlah;
                        $jumlah1 = number_format($jumlah ,2,',','.');
                        $askes = $row->askes; 
                        $askes1 = number_format($askes ,2,',','.');                   

                        $cRet .= " <tr>
                                <td align=\"center\" width=\"5%\" style=\"font-size:12px;border-left:dashed 1px gray;border-right:dashed 1px gray;border-bottom:dashed 1px gray;border-top:dashed 1px gray\" >$no</td>
                                <td align=\"left\" width=\"35%\" style=\"font-size:12px;border-left:dashed 1px gray;border-right:dashed 1px gray;border-bottom:dashed 1px gray;border-top:dashed 1px gray\" >$nm_satkerja</td>
                                ...
                                <td align=\"right\" width=\"10%\" style=\"font-size:12px;border-left:dashed 1px gray;border-right:dashed 1px gray;border-bottom:dashed 1px gray;border-top:dashed 1px gray\" >$t_kel1</td>
                                ...
                                <td align=\"right\" width=\"10%\" style=\"font-size:12px;border-left:dashed 1px gray;border-right:dashed 1px gray;border-bottom:dashed 1px gray;border-top:dashed 1px gray\" >$askes1</td>                
                        ...
                        $cRet .= " <tr>
                                ...
                                <td align=\"center\" width=\"35%\" style=\"font-size:12px;border-left:dashed 1px gray;border-right:dashed 1px gray;border-bottom:dashed 1px gray;border-top:dashed 1px gray\" >JUMLAH KESELURUHAN</td>
                                <td align=\"center\" width=\"10%\" style=\"font-size:12px;border-left:dashed 1px gray;border-right:dashed 1px gray;border-bottom:dashed 1px gray;border-top:dashed 1px gray\" >$jml_peg1</td>
                                <td align=\"right\" width=\"10%\" style=\"font-size:12px;border-left:dashed 1px gray;border-right:dashed 1px gray;border-bottom:dashed 1px gray;border-top:dashed 1px gray\" >$n_gapok1</td>                
                                <td align=\"right\" width=\"10%\" style=\"font-size:12px;border-left:dashed 1px gray;border-right:dashed 1px gray;border-bottom:dashed 1px gray;border-top:dashed 1px gray\" >$t_kel1</td>
                                <td align=\"right\" width=\"10%\" style=\"font-size:12px;border-left:dashed 1px gray;border-right:dashed 1px gray;border-bottom:dashed 1px gray;border-top:dashed 1px gray\" >$jumlah1</td>
                ...
                $cRet .="<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"left\" border=\"0\" cellspacing=\"1\" cellpadding=\"4\">
                    ...
                    $cRet .="</table>";
                $data['prev']= $cRet;
                $judul  = 'Laporan Rekap IURAN BPJS KESEHATAN' .'-'. $nm_satkerja  ;
                ...
                $cRet .="<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"1\" cellpadding=\"1\">
                 ...
                 $cRet .="<table style=\"border-collapse:collapse; border-color: black;\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"1\" cellpadding=\"1\" >
                        ...
                        foreach ($tunjangan as $row){
                            ...
                            $tot_t_kel = $tot_t_kel + $t_kel ;
                            $tot_t_kel1 = number_format($tot_t_kel ,2,',','.');
                            $tot_jumlah = $tot_jumlah + $jumlah ;
                            $tot_jumlah1 = number_format($tot_jumlah ,2,',','.');
                            $tot_askes = $tot_askes + $askes ;
                            $tot_askes1 = number_format($tot_askes ,2,',','.');                  
                            ...
                            $cRet .= " <tr>
                                    ...
                                    <td align=\"right\" width=\"10%\" style=\"font-size:12px;border-left:dashed 1px gray;border-right:dashed 1px gray;border-bottom:dashed 1px gray;border-top:dashed 1px gray\" >$tot_t_kel1</td>
                                    ...
                                    <td align=\"right\" width=\"10%\" style=\"font-size:12px;border-left:dashed 1px gray;border-right:dashed 1px gray;border-bottom:dashed 1px gray;border-top:dashed 1px gray\" >$tot_askes1</td>                
                                    <td align=\"center\" width=\"10%\" style=\"font-size:12px;border-left:dashed 1px gray;border-right:dashed 1px gray;border-bottom:dashed 1px gray;border-top:dashed 1px gray\" ></td>
                                    </tr>";
                    ...
                    $cRet .="</table>";
                    $data['prev']= $cRet;
                    $judul  = 'Laporan Rekap BPJS KESEHATAN Keseluruhan';
                    if (isset($_POST['cetak'])) {
                        $this->_mpdf('',$cRet,'','','',8,0,0,0);
                    }else{
                        header("Cache-Control: no-cache, no-store, must-revalidate");
