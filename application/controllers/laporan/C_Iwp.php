    ...
    public function iwp(){
        ...
        if (isset($_POST['kd_skpd1'])) {
            ...
            $cRet .="<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"1\" cellpadding=\"1\">
                    ...
                    <tr>
                        <td align=\"center\" style=\"font-size:12px;border: solid 1px white;\">HASIL PEMUNGUTAN IURAN WAJIB PEGAWAI NEGERI SIPIL DAERAH</td>
                    </tr>
                    ";
                    $cRet.="</table>";
            $cRet .="<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"1\" cellpadding=\"1\">
             ...
             $cRet .="<table style=\"border-collapse:collapse; border-color: black;\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"1\" cellpadding=\"1\" >
                    ...
                    <tr>
                        ...
                        <td align=\"center\" width=\"10%\" style=\"font-size:12px;border-left:dashed 1px gray;border-right:dashed 1px gray;border-bottom:dashed 1px gray;border-top:dashed 1px gray\" >JUMLAH IURAN WAJIB 1%</td>
                    ...
                    $sql = "SELECT a.satkerja,a.nm_satkerja,
                        ...
                        (select sum(iwp) as iwp from pegawai d where d.satkerja=a.satkerja) as iwp
                    ...
                    foreach ($tunjangan as $row){
                        ...
                        $cRet .= " <tr>
                                ...
                                <td align=\"right\" width=\"10%\" style=\"font-size:12px;border-left:dashed 1px gray;border-right:dashed 1px gray;border-bottom:dashed 1px gray;border-top:dashed 1px gray\" >$iwp1</td>                
                ...
                $cRet .="<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"left\" border=\"0\" cellspacing=\"1\" cellpadding=\"4\">
                    ...
                    $cRet .="</table>";
                $data['prev']= $cRet;
                $judul  = 'Laporan Rekap IWP' .'-'. $nm_satkerja  ;
                ...
                $cRet .="<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"1\" cellpadding=\"1\">
                 ...
                 $cRet .="<table style=\"border-collapse:collapse; border-color: black;\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"1\" cellpadding=\"1\" >
                        ...
                        foreach ($tunjangan as $row){
                            ...
                            $tot_iwp = $tot_iwp + $iwp ;
                            $tot_iwp1 = number_format($tot_iwp ,2,',','.');                  
                            ...
                            $cRet .= " <tr>
                                    ...
                                    <td align=\"right\" width=\"10%\" style=\"font-size:12px;border-left:dashed 1px gray;border-right:dashed 1px gray;border-bottom:dashed 1px gray;border-top:dashed 1px gray\" >$tot_iwp1</td>                
                                    <td align=\"center\" width=\"10%\" style=\"font-size:12px;border-left:dashed 1px gray;border-right:dashed 1px gray;border-bottom:dashed 1px gray;border-top:dashed 1px gray\" ></td>
                                    </tr>";
                    $cRet .="</table>";
                ...
                $cRet .="<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"left\" border=\"0\" cellspacing=\"1\" cellpadding=\"4\">
                    ...
                    $cRet .="</table>"; 
                    $data['prev']= $cRet;
                    $judul  = 'Laporan Rekap IWP Keseluruhan';
                    if (isset($_POST['cetak'])) {
                        $this->_mpdf('',$cRet,'','','',8,0,0,0);
                    }else{
                        header("Cache-Control: no-cache, no-store, must-revalidate");
