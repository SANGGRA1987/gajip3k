...
class C_pph_gaji13 extends CI_Controller {
    ...
    public function pph(){
    	...
    	if (isset($_POST['kd_skpd1'])) {
            ...
            $cRet .="<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"1\" cellpadding=\"1\">
                    ...
                    <tr>
                        <td align=\"left\" width=\"100\" style=\"font-size:12px;border: solid 1px white;\">BULAN &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: GAJI KE 13 $tahun</td>
                    </tr>
                    ";
                    $cRet.="</table>";
             $cRet .="<table style=\"border-collapse:collapse; border-color: black;\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"1\" cellpadding=\"1\" >
                    ...
                    $sql = "SELECT a.satkerja,a.nm_satkerja,
                        (select sum(pph) from public.pegawai_13 b where b.satkerja=a.satkerja and left(b.golongan,1) = '1' ) as gol_1,
                        (select sum(pph) from public.pegawai_13 b where b.satkerja=a.satkerja and left(b.golongan,1) = '2' ) as gol_2,
                        (select sum(pph) from public.pegawai_13 b where b.satkerja=a.satkerja and left(b.golongan,1) = '3' ) as gol_3,
                        (select sum(pph) from public.pegawai_13 b where b.satkerja=a.satkerja and left(b.golongan,1) = '4' ) as gol_4
                ...
                $cRet .="<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"left\" border=\"0\" cellspacing=\"1\" cellpadding=\"4\">
                    ...
                    $cRet .="</table>";
                $data['prev']= $cRet;
                $judul  = 'Laporan Rekap PPH GAJI Ke 13' .'-'. $nm_satkerja;
                ...
                $cRet .="<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"1\" cellpadding=\"1\">
                 ...
                 $cRet .="<table style=\"border-collapse:collapse; border-color: black;\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"1\" cellpadding=\"1\" >
                    ...
                    $cRet .="</table>";
                    $data['prev']= $cRet;
                    $judul  = 'Laporan Rekap PPH Gaji Ke 13 Keseluruhan';
                    if (isset($_POST['cetak'])) {
                        $this->_mpdf('',$cRet,'','','',8,0,0,0);
                    }else{
                        header("Cache-Control: no-cache, no-store, must-revalidate");
