...
class C_formb extends CI_Controller {
	...
	{	
		$data = array(
			'page'	 	=> 'LAPORAN DAFTAR GAJI PEGAWAI ',
			'judul'		=> 'LAPORAN DAFTAR GAJI PEGAWAI ',
			'deskripsi'	=> 'LAPORAN DAFTAR GAJI PEGAWAI '
		);
	...
	public function cetakLaporan()
	{
		...
		//echo $where;
		 ...
		 $cRet .="
		        ...
		        $data['prev']= $cRet;
		        $judul  = 'Laporan Daftar Gaji Pegawai ' .'-'. $nmskpd .'-'. $nm_skpd_unit;
		        switch ($jenisCetak) {
		        	case 0:
