...
class C_formb_gaji13 extends CI_Controller {

	public function __construct()
	{
		parent::__construct();
		//Do your magic here
		$this->load->model('laporan/lap_formb/M_formb_gaji13');
	}
	...
	{	
		$data = array(
			'page'	 	=> 'LAPORAN DAFTAR GAJI 13 PEGAWAI P3K',
			'judul'		=> 'LAPORAN DAFTAR GAJI 13 PEGAWAI P3K',
			'deskripsi'	=> 'LAPORAN DAFTAR GAJI 13 PEGAWAI P3K'
		);

		$this->template->views('laporan/lap_formb/V_formb_gaji13', $data);
	}
	...
	{
		return $this->M_formb_gaji13->getConfig();
	}

	public function getBulan()
	{
		echo $this->M_formb_gaji13->getBulan();
	}

	public function getTahun()
	{
		echo $this->M_formb_gaji13->getTahun();
	}

	public function getSkpd()
	{
		echo $this->M_formb_gaji13->getSkpd(); 
	}

	public function getUnitSkpd()
	{
		$param = $this->uri->segment(5);
		echo $this->M_formb_gaji13->getUnitSkpd($param);
	}
	...
	public function cetakLaporan()
	{
		...
		$bluePrint = $this->M_formb_gaji13->cetakLaporan($data);
		 ...
		 $cRet .="
				<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"1\" cellpadding=\"6\">
                	<thead>
                		...
                		<tr>
                	    	<td align=\"center\" colspan=\"15\" style=\"font-size:10px;border-right:none;border-left:none;border-bottom:none;border-top:none\" ><b>DAFTAR PEMBAYARAN GAJI 13 P3K</b></td>
                		</tr>
                		<tr>
                		...
                		<tr>
		                    <td align=\"center\" colspan=\"15\" style=\"font-size:10px;border-right:none;border-left:none;border-bottom:none;border-top:none\" ><b>BULAN : GAJI KE 13 $thn</b></td>
                		</tr>
                		<tr>
                		...
                		<tr>
		                    ...
		                    <td align=\"center\" border=\"1\" rowspan=\"2\" width=\"12%\" style=\"font-size:9px;border-left:dashed 1px gray;border-right:dashed 1px gray;border-bottom:dashed 1px gray;border-top:dashed 1px gray\">NAMA PEGAWAI<br>TANGGAL LAHIR</br><br>N I P</br><br>STATUS PEGAWAI/GOLONGAN</br></td>
                	...
                	$sql="SELECT satkerja,nip_lama,nama,lahir,golongan,
                		...
                		pph,askes,bruto,iwp,sewa,tabungan,hutang,lain,disc as jum_pot,netto,npwp,rekening,jkk,jkm,khusus,tht from pegawai_13 $where2  order by golongan desc ,masa_tahun desc;";
					$query = $this->db->query($sql);
			        	...
			        	$cRet .="
			                        ...
			                        <td align=\"left\" border=\"1\" width=\"12%\" style=\"font-size:9px;border-left:dashed 1px gray;border-right:dashed 1px gray;border-bottom:dashed 1px gray;border-top:dashed 1px gray\">$nama<br>Tgl Lahir. $lahir</br><br>NIP. $nip</br><br>GOL. $nm_golongan       $nm_stspegawai</br></td>
									...
									<td align=\"right\" border=\"1\" width=\"6%\" style=\"font-size:9px;border-left:dashed 1px gray;border-right:dashed 1px gray;border-bottom:dashed 1px gray;border-top:dashed 1px gray\">".number_format($iwp,2,',','.')."<br>".number_format($tht,2,',','.')."</br><br>".number_format(0,2,',','.')."</br></td>
									<td align=\"right\" border=\"1\" width=\"6%\" style=\"font-size:9px;border-left:dashed 1px gray;border-right:dashed 1px gray;border-bottom:dashed 1px gray;border-top:dashed 1px gray\">".number_format($pph,2,',','.')."<br>".number_format(0,2,',','.')."</br><br>".number_format(0,2,',','.')."</br></td>
			             	...
			             	if ($z==0) {			             		
								...
								$cRet .="
								 <tr>
			                        ...
			                        <td align=\"left\" border=\"1\" width=\"12%\" style=\"font-size:9px;border-left:dashed 1px gray;border-right:dashed 1px gray;border-bottom:dashed 1px gray;border-top:dashed 1px gray\"><b>JUMLAH LEMBAR KE $xz</b></td>
									...
									<td align=\"right\" border=\"1\" width=\"6%\" style=\"font-size:9px;border-left:dashed 1px gray;border-right:dashed 1px gray;border-bottom:dashed 1px gray;border-top:dashed 1px gray\">".number_format($caskes,2,',','.')."</br></td>
									...
									<td align=\"right\" border=\"1\" width=\"6%\" style=\"font-size:9px;border-left:dashed 1px gray;border-right:dashed 1px gray;border-bottom:dashed 1px gray;border-top:dashed 1px gray\">".number_format($ciwp,2,',','.')."<br>".number_format($ctht,2,',','.')."</br><br>".number_format(0,2,',','.')."</br></td>
									<td align=\"right\" border=\"1\" width=\"6%\" style=\"font-size:9px;border-left:dashed 1px gray;border-right:dashed 1px gray;border-bottom:dashed 1px gray;border-top:dashed 1px gray\">".number_format($cpph,2,',','.')."<br>".number_format(0,2,',','.')."</br><br>".number_format(0,2,',','.')."</br></td>
					...
					$sql2="select 'KESELURUHAN' AS jumlah,
					...
					foreach ($query3->result() as $row) {
 					...
 					$sql1="select count(*) as jum from pegawai_13 $where2 ;";
		        ...
		        $data['prev']= $cRet;
		        $judul  = 'Laporan Daftar Gaji 13 Pegawai P3K' .'-'. $nmskpd .'-'. $nm_skpd_unit;
		        switch ($jenisCetak) {
		        	case 0:
