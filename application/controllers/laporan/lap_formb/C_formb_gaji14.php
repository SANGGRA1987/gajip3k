...
class C_formb_gaji14 extends CI_Controller {

	public function __construct()
	{
		parent::__construct();
		//Do your magic here
		$this->load->model('laporan/lap_formb/M_formb_gaji14');
	}
	...
	{	
		$data = array(
			'page'	 	=> 'LAPORAN DAFTAR GAJI 14 PEGAWAI P3K',
			'judul'		=> 'LAPORAN DAFTAR GAJI 14 PEGAWAI P3K',
			'deskripsi'	=> 'LAPORAN DAFTAR GAJI 14 PEGAWAI P3K'
		);

		$this->template->views('laporan/lap_formb/V_formb_gaji14', $data);
	}
	...
	{
		return $this->M_formb_gaji14->getConfig();
	}

	public function getBulan()
	{
		echo $this->M_formb_gaji14->getBulan();
	}

	public function getTahun()
	{
		echo $this->M_formb_gaji14->getTahun();
	}

	public function getSkpd()
	{
		echo $this->M_formb_gaji14->getSkpd(); 
	}

	public function getUnitSkpd()
	{
		$param = $this->uri->segment(5);
		echo $this->M_formb_gaji14->getUnitSkpd($param);
	}
	...
	public function cetakLaporan()
	{
		...
		$bluePrint = $this->M_formb_gaji14->cetakLaporan($data);
		 ...
		 $cRet .="
				<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"1\" cellpadding=\"6\">
                	<thead>
                		...
                		<tr>
                	    	<td align=\"center\" colspan=\"15\" style=\"font-size:10px;border-right:none;border-left:none;border-bottom:none;border-top:none\" ><b>DAFTAR PEMBAYARAN GAJI 14 P3K</b></td>
                		</tr>
                		<tr>
                		...
                		<tr>
		                    <td align=\"center\" colspan=\"15\" style=\"font-size:10px;border-right:none;border-left:none;border-bottom:none;border-top:none\" ><b>BULAN : GAJI KE 14 $thn</b></td>
                		</tr>
                		<tr>
                	...
                	$sql="SELECT satkerja,nip_lama,nama,lahir,golongan,
                		...
                		pph,askes,bruto,iwp,sewa,tabungan,hutang,lain,disc as jum_pot,netto,npwp,rekening,jkk,jkm,khusus,tht from pegawai_14 $where2  order by golongan desc ,masa_tahun desc;";
					...
					foreach ($query3->result() as $row) {
 					...
 					$sql1="select count(*) as jum from pegawai_14 $where2 ;";
