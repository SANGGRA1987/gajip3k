...
class C_rekap_golongan_gaji13 extends CI_Controller {

	public function __construct()
	{
		parent::__construct();
		//Do your magic here
		$this->load->model('laporan/lap_rekapitulasi/M_rekap_golongan_gaji13');
	}
	...
	{	
		$data = array(
			'page'	 	=> 'LAPORAN GAJI 13 PER GOLONGAN',
			'judul'		=> 'LAPORAN GAJI 13 PER GOLONGAN',
			'deskripsi'	=> 'LAPORAN GAJI 13 PER GOLONGAN'
		);

		$this->template->views('laporan/lap_rekapitulasi/V_rekap_golongan_gaji13', $data);
	}
	...
	{
		return $this->M_rekap_golongan_gaji13->getConfig();
	}

	public function getBulan()
	{
		echo $this->M_rekap_golongan_gaji13->getBulan();
	}

	public function getTahun()
	{
		echo $this->M_rekap_golongan_gaji13->getTahun();
	}

	public function getSkpd()
	{
		echo $this->M_rekap_golongan_gaji13->getSkpd(); 
	}

	public function getUnitSkpd()
	{
		$param = $this->uri->segment(5);
		echo $this->M_rekap_golongan_gaji13->getUnitSkpd($param);
	}
	...
	public function cetakLaporan()
	{
		...
		$bluePrint = $this->M_rekap_golongan_gaji13->cetakLaporan($data);
        ...
        $cRet .= "
        		<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"center\" border=\"0\" cellspacing=\"1\" cellpadding=\"1\">
            		<tr>
                		<td></td>
                		<td align=\"center\" colspan=\"13\" style=\"font-size:14px;border: solid 1px white;\"><B>REKAPITULASI DAFTAR GAJI 13 PEGAWAI PER GOLONGAN</B></td>
            		</tr><BR/><BR/>
        		</table>
        		";
        ...
        $cRet .="
        		<table style=\"font-size:12px;border-collapse:collapse;\" width=\"100%\" align=\"left\" border=\"0\" cellspacing=\"1\" cellpadding=\"4\">
                    ...
                    <tr>
						...
						<td align=\"center\" width=\"1%\">:</td>
						<td align=\"left\" width=\"80%\"><b>GAJI KE 13 $thn</b></td>		
					</tr> 
		...
		$cRet .="
				<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"1\" cellpadding=\"1\">
                	<thead>
                		...
                		$sql = "SELECT DISTINCT golongan,
								...
								case 
								when golongan in ('1') then (select count(*) from pegawai_13 $where golongan in ('1') and kdbantu<>'6')
								when golongan in ('2') then (select count(*) from pegawai_13 $where golongan in ('2') and kdbantu<>'6')
								when golongan in ('3') then (select count(*) from pegawai_13 $where golongan in ('3') and kdbantu<>'6')
								when golongan in ('4') then (select count(*) from pegawai_13 $where golongan in ('4') and kdbantu<>'6')
								when golongan in ('5') then (select count(*) from pegawai_13 $where golongan in ('5') and kdbantu<>'6')
								when golongan in ('6') then (select count(*) from pegawai_13 $where golongan in ('6') and kdbantu<>'6')
								when golongan in ('7') then (select count(*) from pegawai_13 $where golongan in ('7') and kdbantu<>'6')
								when golongan in ('8') then (select count(*) from pegawai_13 $where golongan in ('8') and kdbantu<>'6')
								when golongan in ('9') then (select count(*) from pegawai_13 $where golongan in ('9') and kdbantu<>'6')
								when golongan in ('10') then (select count(*) from pegawai_13 $where golongan in ('10') and kdbantu<>'6')
								when golongan in ('11') then (select count(*) from pegawai_13 $where golongan in ('11') and kdbantu<>'6')
								when golongan in ('12') then (select count(*) from pegawai_13 $where golongan in ('12') and kdbantu<>'6')
								when golongan in ('13') then (select count(*) from pegawai_13 $where golongan in ('13') and kdbantu<>'6')
								when golongan in ('14') then (select count(*) from pegawai_13 $where golongan in ('14') and kdbantu<>'6')
								when golongan in ('15') then (select count(*) from pegawai_13 $where golongan in ('15') and kdbantu<>'6')
								when golongan in ('16') then (select count(*) from pegawai_13 $where golongan in ('16') and kdbantu<>'6')
								when golongan in ('17') then (select count(*) from pegawai_13 $where golongan in ('17') and kdbantu<>'6')
								else 0 END AS jum_peg,
								case 
								when golongan in ('1') then (select count(*) from pegawai_13 $where golongan in ('1') and stskawin=1 and (kdbantu<>'6' and kdbantu<>'4'))
								when golongan in ('2') then (select count(*) from pegawai_13 $where golongan in ('2') and stskawin=1 and (kdbantu<>'6' and kdbantu<>'4'))
								when golongan in ('3') then (select count(*) from pegawai_13 $where golongan in ('3') and stskawin=1 and (kdbantu<>'6' and kdbantu<>'4'))
								when golongan in ('4') then (select count(*) from pegawai_13 $where golongan in ('4') and stskawin=1 and (kdbantu<>'6' and kdbantu<>'4'))
								when golongan in ('5') then (select count(*) from pegawai_13 $where golongan in ('5') and stskawin=1 and (kdbantu<>'6' and kdbantu<>'4'))
								when golongan in ('6') then (select count(*) from pegawai_13 $where golongan in ('6') and stskawin=1 and (kdbantu<>'6' and kdbantu<>'4'))
								when golongan in ('7') then (select count(*) from pegawai_13 $where golongan in ('7') and stskawin=1 and (kdbantu<>'6' and kdbantu<>'4'))
								when golongan in ('8') then (select count(*) from pegawai_13 $where golongan in ('8') and stskawin=1 and (kdbantu<>'6' and kdbantu<>'4'))
								when golongan in ('9') then (select count(*) from pegawai_13 $where golongan in ('9') and stskawin=1 and (kdbantu<>'6' and kdbantu<>'4'))
								when golongan in ('10') then (select count(*) from pegawai_13 $where golongan in ('10') and stskawin=1 and (kdbantu<>'6' and kdbantu<>'4'))
								when golongan in ('11') then (select count(*) from pegawai_13 $where golongan in ('11') and stskawin=1 and (kdbantu<>'6' and kdbantu<>'4'))
								when golongan in ('12') then (select count(*) from pegawai_13 $where golongan in ('12') and stskawin=1 and (kdbantu<>'6' and kdbantu<>'4'))
								when golongan in ('13') then (select count(*) from pegawai_13 $where golongan in ('13') and stskawin=1 and (kdbantu<>'6' and kdbantu<>'4'))
								when golongan in ('14') then (select count(*) from pegawai_13 $where golongan in ('14') and stskawin=1 and (kdbantu<>'6' and kdbantu<>'4'))
								when golongan in ('15') then (select count(*) from pegawai_13 $where golongan in ('15') and stskawin=1 and (kdbantu<>'6' and kdbantu<>'4'))
								when golongan in ('16') then (select count(*) from pegawai_13 $where golongan in ('16') and stskawin=1 and (kdbantu<>'6' and kdbantu<>'4'))
								when golongan in ('17') then (select count(*) from pegawai_13 $where golongan in ('17') and stskawin=1 and (kdbantu<>'6' and kdbantu<>'4'))								
								else 0 END AS jum_istri,
								case 
								when golongan in ('1') then (select sum(anak) from pegawai_13 $where golongan in ('1') and (kdbantu<>'6' and kdbantu<>'4'))
								when golongan in ('2') then (select sum(anak) from pegawai_13 $where golongan in ('2') and (kdbantu<>'6' and kdbantu<>'4'))
								when golongan in ('3') then (select sum(anak) from pegawai_13 $where golongan in ('3') and (kdbantu<>'6' and kdbantu<>'4'))
								when golongan in ('4') then (select sum(anak) from pegawai_13 $where golongan in ('4') and (kdbantu<>'6' and kdbantu<>'4'))
								when golongan in ('5') then (select sum(anak) from pegawai_13 $where golongan in ('5') and (kdbantu<>'6' and kdbantu<>'4'))
								when golongan in ('6') then (select sum(anak) from pegawai_13 $where golongan in ('6') and (kdbantu<>'6' and kdbantu<>'4'))
								when golongan in ('7') then (select sum(anak) from pegawai_13 $where golongan in ('7') and (kdbantu<>'6' and kdbantu<>'4'))
								when golongan in ('8') then (select sum(anak) from pegawai_13 $where golongan in ('8') and (kdbantu<>'6' and kdbantu<>'4'))
								when golongan in ('9') then (select sum(anak) from pegawai_13 $where golongan in ('9') and (kdbantu<>'6' and kdbantu<>'4'))
								when golongan in ('10') then (select sum(anak) from pegawai_13 $where golongan in ('10') and (kdbantu<>'6' and kdbantu<>'4'))
								when golongan in ('11') then (select sum(anak) from pegawai_13 $where golongan in ('11') and (kdbantu<>'6' and kdbantu<>'4'))
								when golongan in ('12') then (select sum(anak) from pegawai_13 $where golongan in ('12') and (kdbantu<>'6' and kdbantu<>'4'))
								when golongan in ('13') then (select sum(anak) from pegawai_13 $where golongan in ('13') and (kdbantu<>'6' and kdbantu<>'4'))
								when golongan in ('14') then (select sum(anak) from pegawai_13 $where golongan in ('14') and (kdbantu<>'6' and kdbantu<>'4'))
								when golongan in ('15') then (select sum(anak) from pegawai_13 $where golongan in ('15') and (kdbantu<>'6' and kdbantu<>'4'))
								when golongan in ('16') then (select sum(anak) from pegawai_13 $where golongan in ('16') and (kdbantu<>'6' and kdbantu<>'4'))
								when golongan in ('17') then (select sum(anak) from pegawai_13 $where golongan in ('17') and (kdbantu<>'6' and kdbantu<>'4'))
								else 0 END AS jum_anak from pegawai_13 $where2 ORDER BY golongan;";
						        ...
						        foreach ($query->result() as $row) {			                
										...
										if ($this->input->get('skpd')!='') {
											...
											sum(tht) as tht from pegawai_13 WHERE satkerja = '$skpd' and golongan in $cgolongan;";
										}else{
											$sql1 = "SELECT 
											sum(gapok) as gapok,sum(tistri) as tistri,sum(tanak) as tanak,
											sum(gapok+tistri+tanak) as tkeluarga,sum(tpp) as tpp,sum(papua) as papua,sum(tdt) as tdt,sum(tstruk) as tstruk,
											...
											sum(iwp) as iwp,sum(sewa) as sewa,sum(tabungan) as tabungan,sum(hutang) as hutang,
											sum(lain) as lain,sum(disc) as jum_pot,sum(netto) as netto, sum(jkk) as jkk, sum(jkm) as jkm, sum(khusus) as khusus,
											sum(tht) as tht from pegawai_13 WHERE golongan in $cgolongan;";
										}
			    	...
			    	$sql2="SELECT 'JUMLAH' AS jumlah,
							(select count(*) from pegawai_13 $where kdbantu<>'6') AS jum_peg,
							(select count(*) from pegawai_13 $where stskawin=1 and (kdbantu<>'6' and kdbantu<>'4')) AS jum_istri,
							(select sum(anak) from pegawai_13 $where (kdbantu<>'6' and kdbantu<>'4')) as jum_anak,
							(select count(*) from pegawai_13 $where (kdbantu<>'6' and kdguru<>'4' and kdguru<>'5')) as jum_nonguru,
							(select count(*) from pegawai_13 $where (kdbantu<>'6' and kdguru='4')) as jum_guru,
							(select count(*) from pegawai_13 $where (kdbantu<>'6' and kdguru='5')) as jum_kes,
							sum(gapok) as gapok,sum(tistri) as tistri,sum(tanak) as tanak,
							sum(gapok+tistri+tanak) as tkeluarga,sum(tpp) as tpp,sum(papua) as papua,sum(tdt) as tdt,sum(tstruk) as tstruk,
							sum(case when left(kd_fung,1)<>'U' then tfung else 0 end) as tfung,sum(bulat) as bulat,sum(beras) as beras,
							...
							sum(netto) as netto,sum(jkk) as jkk, sum(jkm) as jkm, sum(khusus) as khusus, sum(tht) as tht from pegawai_13 $where2;";
		        ...
		        $data['prev']= $cRet;
		        $judul  = 'Laporan Rekap Gaji 13 Per Golongan';
		        switch ($jenisCetak) {
		        	case 0:
