...
class C_rekap_kulit_gaji13 extends CI_Controller {

	public function __construct()
	{
		parent::__construct();
		//Do your magic here
		$this->load->model('laporan/lap_rekapitulasi/M_rekap_kulit_gaji13');
	}
	...
	{	
		$data = array(
			'page'	 	=> 'LAPORAN REKAP KULIT GAJI 13',
			'judul'		=> 'LAPORAN REKAP KULIT GAJI 13',
			'deskripsi'	=> 'LAPORAN REKAP KULIT GAJI 13'
		);

		$this->template->views('laporan/lap_rekapitulasi/V_rekap_kulit_gaji13', $data);
	}
	...
	{
		return $this->M_rekap_kulit_gaji13->getConfig();
	}

	public function getBulan()
	{
		echo $this->M_rekap_kulit_gaji13->getBulan();
	}

	public function getTahun()
	{
		echo $this->M_rekap_kulit_gaji13->getTahun();
	}

	public function getSkpd()
	{
		echo $this->M_rekap_kulit_gaji13->getSkpd(); 
	}

	public function getUnitSkpd()
	{
		$param = $this->uri->segment(5);
		echo $this->M_rekap_kulit_gaji13->getUnitSkpd($param);
	}
	...
	public function cetakLaporan()
	{
		...
		$bluePrint = $this->M_rekap_kulit_gaji13->cetakLaporan($data);
			...
			$cRet .= "
	        		<table style=\"border-collapse:collapse; font-size:10px\" width=\"100%\" align=\"center\" border=\"0\" cellspacing=\"1\" cellpadding=\"1\">
	            		...
	            		<tr>
	                		...
	                		<td align=\"center\" width=\"40%\" style=\"border-left:dashed 1px gray;border-right:dashed 1px gray;\">GAJI 13 P3K UNTUK PARA PEGAWAI</td>
	            		...
	            		<tr>
	                		...
	                		<td align=\"center\" width=\"40%\" style=\"border-left:dashed 1px gray;border-right:dashed 1px gray;border-bottom:dashed 1px gray;\">BULAN : GAJI KE 13 $thn</td>
	        		...
	        		$sqljiwa = "SELECT distinct
							case when golongan='1' then (select count(*) from pegawai_13 $where kdbantu<>'6')
							when golongan='2' then (select count(*) from pegawai_13 $where kdbantu<>'6')
							when golongan='3' then (select count(*) from pegawai_13 $where kdbantu<>'6')
							when golongan='4' then (select count(*) from pegawai_13 $where kdbantu<>'6') 
							when golongan='5' then (select count(*) from pegawai_13 $where kdbantu<>'6')
							when golongan='6' then (select count(*) from pegawai_13 $where kdbantu<>'6')
							when golongan='7' then (select count(*) from pegawai_13 $where kdbantu<>'6')
							when golongan='8' then (select count(*) from pegawai_13 $where kdbantu<>'6')
							when golongan='9' then (select count(*) from pegawai_13 $where kdbantu<>'6')
							when golongan='10' then (select count(*) from pegawai_13 $where kdbantu<>'6')
							when golongan='11' then (select count(*) from pegawai_13 $where kdbantu<>'6')
							when golongan='12' then (select count(*) from pegawai_13 $where kdbantu<>'6')
							when golongan='13' then (select count(*) from pegawai_13 $where kdbantu<>'6')
							when golongan='14' then (select count(*) from pegawai_13 $where kdbantu<>'6')
							when golongan='15' then (select count(*) from pegawai_13 $where kdbantu<>'6')
							when golongan='16' then (select count(*) from pegawai_13 $where kdbantu<>'6')
							when golongan='17' then (select count(*) from pegawai_13 $where kdbantu<>'6') else 0 END AS jum_peg_jiwa,
							case when golongan='1' then (select count(*) from pegawai_13 $where stskawin=1 and (kdbantu<>'6' and kdbantu<>'4'))
							when golongan='2' then (select count(*) from pegawai_13 $where stskawin=1 and (kdbantu<>'6' and kdbantu<>'4'))
							when golongan='3' then (select count(*) from pegawai_13 $where stskawin=1 and (kdbantu<>'6' and kdbantu<>'4'))
							when golongan='4' then (select count(*) from pegawai_13 $where stskawin=1 and (kdbantu<>'6' and kdbantu<>'4')) 
							when golongan='5' then (select count(*) from pegawai_13 $where stskawin=1 and (kdbantu<>'6' and kdbantu<>'4'))
							when golongan='6' then (select count(*) from pegawai_13 $where stskawin=1 and (kdbantu<>'6' and kdbantu<>'4'))
							when golongan='7' then (select count(*) from pegawai_13 $where stskawin=1 and (kdbantu<>'6' and kdbantu<>'4'))
							when golongan='8' then (select count(*) from pegawai_13 $where stskawin=1 and (kdbantu<>'6' and kdbantu<>'4'))
							when golongan='9' then (select count(*) from pegawai_13 $where stskawin=1 and (kdbantu<>'6' and kdbantu<>'4'))
							when golongan='10' then (select count(*) from pegawai_13 $where stskawin=1 and (kdbantu<>'6' and kdbantu<>'4'))
							when golongan='11' then (select count(*) from pegawai_13 $where stskawin=1 and (kdbantu<>'6' and kdbantu<>'4'))
							when golongan='12' then (select count(*) from pegawai_13 $where stskawin=1 and (kdbantu<>'6' and kdbantu<>'4'))
							when golongan='13' then (select count(*) from pegawai_13 $where stskawin=1 and (kdbantu<>'6' and kdbantu<>'4'))
							when golongan='14' then (select count(*) from pegawai_13 $where stskawin=1 and (kdbantu<>'6' and kdbantu<>'4'))
							when golongan='15' then (select count(*) from pegawai_13 $where stskawin=1 and (kdbantu<>'6' and kdbantu<>'4'))
							when golongan='16' then (select count(*) from pegawai_13 $where stskawin=1 and (kdbantu<>'6' and kdbantu<>'4'))
							when golongan='17' then (select count(*) from pegawai_13 $where stskawin=1 and (kdbantu<>'6' and kdbantu<>'4'))
							else 0 END AS jum_istri_jiwa,
							case when golongan='1' then (select sum(anak) from pegawai_13 $where (kdbantu<>'6' and kdbantu<>'4'))
							when golongan='2' then (select sum(anak) from pegawai_13 $where (kdbantu<>'6' and kdbantu<>'4'))
							when golongan='3' then (select sum(anak) from pegawai_13 $where (kdbantu<>'6' and kdbantu<>'4'))
							when golongan='4' then (select sum(anak) from pegawai_13 $where (kdbantu<>'6' and kdbantu<>'4'))
							when golongan='5' then (select sum(anak) from pegawai_13 $where (kdbantu<>'6' and kdbantu<>'4'))
							when golongan='6' then (select sum(anak) from pegawai_13 $where (kdbantu<>'6' and kdbantu<>'4'))
							when golongan='7' then (select sum(anak) from pegawai_13 $where (kdbantu<>'6' and kdbantu<>'4'))
							when golongan='8' then (select sum(anak) from pegawai_13 $where (kdbantu<>'6' and kdbantu<>'4'))
							when golongan='9' then (select sum(anak) from pegawai_13 $where (kdbantu<>'6' and kdbantu<>'4'))
							when golongan='10' then (select sum(anak) from pegawai_13 $where (kdbantu<>'6' and kdbantu<>'4'))
							when golongan='11' then (select sum(anak) from pegawai_13 $where (kdbantu<>'6' and kdbantu<>'4'))
							when golongan='12' then (select sum(anak) from pegawai_13 $where (kdbantu<>'6' and kdbantu<>'4'))
							when golongan='13' then (select sum(anak) from pegawai_13 $where (kdbantu<>'6' and kdbantu<>'4'))
							when golongan='14' then (select sum(anak) from pegawai_13 $where (kdbantu<>'6' and kdbantu<>'4'))
							when golongan='15' then (select sum(anak) from pegawai_13 $where (kdbantu<>'6' and kdbantu<>'4'))
							when golongan='16' then (select sum(anak) from pegawai_13 $where (kdbantu<>'6' and kdbantu<>'4'))
							when golongan='17' then (select sum(anak) from pegawai_13 $where (kdbantu<>'6' and kdbantu<>'4'))
							else 0 END AS jum_anak_jiwa from pegawai_13 $where2;";
	                		...
	                		<td width=\"50%\" valign=\"top\" align=\"left\" style=\"border-right:dashed 1px gray;;\">
	                			<table style=\"border-collapse:collapse;border-bottom:dashed 1px gray;font-family: Times New Roman; font-size:10px\" width=\"500\" align=\"left\" border=\"0\" cellspacing=\"0\" cellpadding=\"1\">
	                                ...
	                                if ($this->input->get('skpd')!='') {
										...
										from pegawai_13 $where2 group by satkerja;";
									}else{
	                		...
	                		<td width=\"50%\" valign=\"top\" align=\"left\">
	                			<table style=\"border-collapse:collapse;border-right:dashed 1px gray;font-family: Times New Roman; font-size:10px\" width=\"600\" align=\"left\" border=\"0\" cellspacing=\"0\" cellpadding=\"1\">
	                                ...
	                                $sql = "SELECT x.golongan,substr(x.nm_golongan,10,5) as nm_golongan,
										(select count(*) from pegawai_13 $where golongan=x.golongan and kdbantu<>'6') as jum_peg,
										(select count(*) from pegawai_13 $where golongan=x.golongan and stskawin=1 and (kdbantu<>'6' and kdbantu<>'4')) as jum_istri,
										(select sum(anak) from pegawai_13 $where golongan=x.golongan and (kdbantu<>'6' and kdbantu<>'4')) as jum_anak
