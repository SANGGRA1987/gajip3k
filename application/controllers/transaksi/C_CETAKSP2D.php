...
class C_CETAKSP2D extends CI_Controller {
	...
	public function cetaksp2d()
	{
		...
		//$tgl_sp2d = $this->input->get('tgl_sp2d');
		//print_r($tgl_sp2d);die();
		...
		$sql="select a.no_sp2d,a.tgl_sp2d,a.no_spm,a.tgl_spm,c.no_spp,a.kd_skpd,d.nm_satkerja,c.keperluan ,(select sum(nilai) from transaksi.trdspp where no_spp=c.no_spp) as nilai from transaksi.trhsp2d a inner join transaksi.trhspm b on a.no_spm=b.no_spm inner join transaksi.trhspp c on b.no_spp=c.no_spp  inner join public.satkerja d on a.kd_skpd=d.satkerja  $where ;";
		...
		$k=0;
 			...
 			$cRet = '';
    		$cRet = "<table style=\"border-collapse:collapse;font-size:14px\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"-1\" cellpadding=\"-1\">";
   			 $cRet .="
   					 	<tr>
   						 	<td align=\"center\" width=\"50%\"><b>PEMERINTAH KABUPATEN $nm_daerah</b>
   						 	</td>
   						...
   						<tr>
    						<td>
   								 <table style=\"border-collapse:collapse;font-size:10px\" width=\"420\" align=\"left\" border=\"0\" cellspacing=\"4\" cellpadding=\"0\">
    								<tr>
   							...
   							<td>
   								<table style=\"border-collapse:collapse;font-size:10px\" width=\"400\" align=\"center\" border=\"0\" cellspacing=\"4\" cellpadding=\"0\">
    								<tr>
						...
						<tr>
							<td colspan=\"2\"  style=\"border-collapse:collapse;font-size:10px\" height=\"60\"> &nbsp;Bank/Pos : BANK KALBAR<br>&nbsp;Hendaklah mencairkan / memindahbukukan dari bank Rekening Nomor ..............<br>&nbsp;Uang sebesar Rp  ".number_format($nilai_sp2d,'2',',','.')."  <br><i>&nbsp;Terbilang :$terbilang_sp2d</i><br>
							</td>
						</tr>    
						<tr>
                 			<td colspan=\"2\">
               				  <table style=\"border-collapse:collapse;font-size:10px\" width=\"800\" align=\"left\" border=\"0\" cellspacing=\"4\" cellpadding=\"-1\">
					                 <tr>
						                 <td width=\"20%\" height=\"20\">&nbsp;Kepada</td>
						                 <td>:&nbsp;Harap Membayar Kepada Para Pegawai $nm_satkerja se-Kabupaten $nm_daerah yang mempunyai rekening pada Bank KALBAR Cabang</td>
					                 </tr>
					                 <tr>
              		  ...
              		  <tr>
                			 <td colspan=\"2\">
               				    <table style=\"border-collapse:collapse;font-size:10px\" width=\"800\" align=\"left\" border=\"1\" cellspacing=\"4\" cellpadding=\"2\">
		                			 <tr>
						                 <td width=\"50\" align=\"center\"><b>NO</b></td>
						                 <td width=\"150\" align=\"center\"><b>KODE REKENING</b></td>
						                 <td width=\"450\" align=\"center\"><b>URAIAN</b></td>
									...
									inner join public.satkerja e on a.kd_skpd=e.satkerja $where order by d.kd_rek5;";
						...
						<tr>
							<td colspan=\"2\">
							    <table style=\"border-collapse:collapse;font-size:10px\" width=\"800\" align=\"center\" border=\"1\" cellspacing=\"-1\" cellpadding=\"-1\">
							            <tr>
					...
					$totalpot=0;
						$sql3 = "select a.no_sp2d,a.tgl_sp2d,c.kd_kegiatan,d.kd_rek5,d.nm_rek5,d.nilai from transaksi.trhsp2d a inner join transaksi.trhspm b on a.no_spm=b.no_spm inner join transaksi.trhspp c on b.no_spp=c.no_spp inner join transaksi.trspmpot d on b.no_spm=d.no_spm inner join public.satkerja e on a.kd_skpd=e.satkerja $where order  by d.kd_rek5;";
									    ...
									    $cRet .="<tr>
        								 ...
        								 $cRet .="
										         <tr>
											         <td height=\"20\">&nbsp;</td>
											         <td align=\"right\"><b>Jumlah&nbsp;</b></td>
											         <td align=\"right\"><b>".number_format($totalpot,'2',',','.')."&nbsp;</b></td>
											         <td></td>
										         </tr>
										         <tr>
						...
						$sql4 = "select a.no_sp2d,a.tgl_sp2d,c.kd_kegiatan,d.kd_rek5,d.nm_rek5,d.nilai from transaksi.trhsp2d a 
								inner join transaksi.trhspm b on a.no_spm=b.no_spm inner join transaksi.trhspp c on b.no_spp=c.no_spp inner join transaksi.trspmpot d on b.no_spm=d.no_spm 
									inner join public.satkerja e on a.kd_skpd=e.satkerja $where and d.kd_rek5='2130101' order  by d.kd_rek5;";
 						...
 						<tr>
        					 <td colspan=\"2\">
        						 <table style=\"border-collapse:collapse;font-size:10px\" width=\"800\" align=\"center\" border=\"1\" cellspacing=\"-1\" cellpadding=\"-1\">
        							 <tr>
								         <td width=\"60%\" align=\"left\" style=\"font-size:10px\" valign=\"top\">
							
								         <td width=\"40%\" align=\"center\">$kota, $tgl_sp2d<br>$jab_kaban</br><br></br><br></br><br></br><br></br><br></br><br></br>
								         <b><u>$nm_kaban</u></b><br>
								         <b>NIP.$nip_kaban</b>                
								         </td>
								         </tr>";
