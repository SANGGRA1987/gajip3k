...
class C_CETAKSPM extends CI_Controller {
	...
	public function cetakspm()
	{
		...
		$k=0;
			...
			$cRet ='';
       		$cRet .="
       			  <table style=\"border-collapse:collapse;\" width=\"100%\" align=\"center\" border=\"0\" cellspacing=\"1\" cellpadding=\"3\">
	                    ...
	                    <tr><td width=\"100%\" align=\"center\" style=\"font-size:18px;border-collapse:collapse;\"><strong>KABUPATEN $nm_daerah</strong></td></tr>
	        ...
	        $cRet .="<table   width=\"100%\" style=\"border-collapse:collapse;\"  align=\"left\" border=\"1\" cellspacing=\"1\" cellpadding=\"3\">
						<tr>
	        ...
	        $cRet .="<tr>
	                    <td  width=\"50%\" colspan=\"1\" align=\"left\"  style=\"font-size:10px\"><b>KUASA BENDAHARA UMUM DAERAH<br>KABUPATEN $nm_daerah</br></b><br>Supaya Menerbitkan SP2D Kepada :</br></td>            
					...
					$sql="select a.no_spm,a.kd_skpd,d.nm_satkerja,d.nama_bend,d.jab_bend,d.nip_bend,d.nama_atasan,d.nip_atasan,d.jab_atasan,b.no_spd,b.keperluan from transaksi.trhspm a inner join transaksi.trhspp b on a.no_spp=b.no_spp inner join public.satkerja d on left(a.kd_skpd,7)=d.satkerja $where ;";
					 ...
					 $query = $this->db->query($sql); 
			        	...
			        	$cRet .="
	                		<tr>
			                    <td  width=\"50%\" rowspan=\"9\" align=\"left\"  style=\"font-size:10px\">SKPD :$nm_satkerja<br>Bendahara Pengeluaran :$nama_bend</br><br></br><br>No. Rekening Bank :</br><br>Cabang : BANK KALBAR CAB. $nm_daerah DI $kota</br><br></br><br>NPWP :</br><br>Dasar Pembayaran/No. dan Tanggal SPD :</br></td>

			                     "; 
							}

						$cRet .="<td  width=\"5%\" rowspan=\"1\" align=\"center\"  style=\"font-size:10px\"><b>No.</b></td>
					...
					foreach ($query2->result() as $row) {
			       	 	...
			       	 	$cRet .="<tr>
			                	...
			                	<td  width=\"10%\"  rowspan=\"1\" align=\"right\"  style=\"font-size:10px\">".number_format($nilai,2,',','.')."</td>
					...
					$query3 = $this->db->query($sql3); 
 					...
 					foreach ($query3->result() as $row) {		
			        			$total  =$row->total;		
			        	$cRet .="<tr>
			                	<td  width=\"50%\"  rowspan=\"6\" align=\"left\"  style=\"font-size:10px\">Untuk Keperluan :$keperluan<br></br><br></br><br>(1).Belanja Tidak Langsung</br><br>&ensp;2.&ensp;Belanja Langsung</br></td>
			                	<td  rowspan=\"1\" align=\"center\"  style=\"font-size:10px\"></td>
			                	<td  rowspan=\"1\" align=\"right\"  style=\"font-size:10px\"><b>Jumlah</b></td>
			                	<td  rowspan=\"1\" align=\"right\"  style=\"font-size:10px\"><b>Rp.</b></td>
			                	<td  rowspan=\"1\" align=\"right\"  style=\"font-size:10px\"><b>".number_format($total,2,',','.')."</b></td>
				...
				$sql4="select a.no_spm,sum(c.nilai) as jum_spm from transaksi.trhspm a inner join transaksi.trhspp b on a.no_spp=b.no_spp inner join transaksi.trdspp c on b.no_spp=c.no_spp $where group by a.no_spm;";
			        ...
			        $cRet .="			
			                  <tr>
			                	...
			                	<td  rowspan=\"1\" align=\"center\"  style=\"font-size:10px\">Rp.</td>
			                	<td  rowspan=\"1\" align=\"right\"  style=\"font-size:10px\"><b>".number_format($jum_bersih,2,',','.')."</b></td>
			                	<td  rowspan=\"1\" align=\"left\"  style=\"font-size:10px\"></td>
			                  </tr>";
				...
				$sql5="select a.no_spm,c.kd_rek5,c.nm_rek5,c.nilai from transaksi.trhspm a inner join transaksi.trhspp b on a.no_spp=b.no_spp inner join transaksi.trdspp c on b.no_spp=c.no_spp $where order by c.kd_rek5;";
					...
					$cRet .="
	                		<tr>
			                    ...
			                    <td  width=\"30%\" rowspan=\"1\" align=\"right\"  style=\"font-size:10px\">".number_format($nilai,2,',','.')."</td> 
			...
			$sql6="select a.no_spm,sum(c.nilai) as total from transaksi.trhspm a inner join transaksi.trhspp b on a.no_spp=b.no_spp inner join transaksi.trdspp c on b.no_spp=c.no_spp $where group by a.no_spm;";
					...
					$cRet .="
	                		<tr>
			                    ...
			                    <td  rowspan=\"1\" align=\"center\"  style=\"font-size:10px\">Rp.</td> 
			                    <td  rowspan=\"1\" align=\"right\"  style=\"font-size:10px\"><b>".number_format($totalx,2,',','.')."</b></td> 
	                ...
	                $cRet .="
			                	<td  colspan=\"2\" align=\"center\"  style=\"font-size:10px\">$kota, $tgl_spm<br>$jab_atasan</br><br></br><br></br><br></br><br></br><br></br><br></br><br></br><br></br>$nama_atasan<br>NIP.$nip_atasan</br></td>
