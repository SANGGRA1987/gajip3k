...
class C_Proses_gaji13 extends CI_Controller {
	public function __construct()
	{
		parent::__construct();
		$this->load->model('utilitas/M_Proses_gaji13');
	}
	...
	public function getBulan()
	{
		...
		$res = $this->M_Proses_gaji13->getBulan($lccq);
		echo json_encode($res);
	}

	public function getConfig()
	{
		return $this->M_Proses_gaji13->getConfig();
	}
	...
	function proses(){
        ...
        foreach($query->result_array() as $resulte){
			...
			$this->db->query(" insert into public.pegawai_13(nip_lama,nip,nama,nokartu,kota,agama,stskawin,anak,satkerja,unit,golongan,masa_tahun,masa_bulan,eselon,kdbantu,gapok,tstruk,tfung,
