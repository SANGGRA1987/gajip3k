...
class M_SPM extends CI_Model {
	...
	public function untuk($satkerja,$gol1,$gol2) { 
        ...
        $sql = "SELECT count(*) as tot from public.pegawai Where satkerja = '$satkerja' And kdbantu != 6";
        $query1 = $this->db->query($sql);
        $total = $query1->row();
        $result["total"] = $total->tot; 

        $sql1 = "SELECT count(*) as tot from public.pegawai Where satkerja = '$satkerja' And kdbantu != 6 and stskawin = 1 And kdbantu != 4";
        $query2 = $this->db->query($sql1);
        $total2 = $query2->row();
        $result["total2"] = $total2->tot;

		$sql2 = "SELECT Sum(anak) as tot from public.pegawai Where satkerja = '$satkerja' And kdbantu != 6 and kdbantu != 4";
	...
	public function rekening($satkerja,$gol1,$gol2) { 
        ...
        $sql="SELECT '510101010002' as kd_rek5,'Belanja Gaji Pokok PPPK' as nm_rek5, Sum(gapok) as tot, '210108010001' as kd_rek5_pot,'Utang Iuran Wajib Pegawai' as nm_rek5_pot, sum(iwp) as tot_pot from public.pegawai Where satkerja = '$satkerja'  And kdbantu != 6
			union all
			SELECT '510101020002' as kd_rek5,'Belanja Tunjangan Keluarga PPPK' as nm_rek5, Sum(tistri+tanak) as tot, '210101010002' as kd_rek5_pot,'Potongan THT' as nm_rek5_pot, sum(tht) as tot_pot from public.pegawai Where satkerja = '$satkerja'  And kdbantu != 6
			union all
			SELECT '510101030002' as kd_rek5,'Belanja Tunjangan Jabatan PPPK' as nm_rek5, Sum(tstruk) as tot, '210105010001' as kd_rek5_pot,'Utang Pph 21 ' as nm_rek5_pot, sum(pph) as tot_pot from public.pegawai Where satkerja = '$satkerja'  And kdbantu != 6
			union all
			SELECT '510101060002' as kd_rek5,'Belanja Tunjangan Beras PPPK' as nm_rek5, Sum(beras) as tot, '210601010018' as kd_rek5_pot,'Utang Belanja Iuran Jaminan Kesehatan ASN- Iuran Jaminan Kesehatan PPPK' as nm_rek5_pot, sum(askes) as tot_pot from public.pegawai Where satkerja = '$satkerja'  And kdbantu != 6
			union all
			SELECT '510101070002' as kd_rek5,'Belanja Tunjangan PPh/Tunjangan Khusus PPPK' as nm_rek5, Sum(khusus) as tot, '210107010001' as kd_rek5_pot,'Utang Taperum' as nm_rek5_pot, sum(tabungan) as tot_pot from public.pegawai Where satkerja = '$satkerja'  And kdbantu != 6
			union all
			SELECT '510101080002' as kd_rek5,'Belanja Pembulatan Gaji PPPK' as nm_rek5, Sum(bulat) as tot, '210304030001' as kd_rek5_pot,'Utang Tunjangan Lain - Lain' as nm_rek5_pot, sum(lain+sewa+hutang) as tot_pot from public.pegawai Where satkerja = '$satkerja'  And kdbantu != 6
			union all			
			SELECT '510101040002' as kd_rek5,'Belanja Tunjangan Fungsional PPPK' as nm_rek5, Sum(tfung) as tot, '' as kd_rek5_pot,'' as nm_rek5_pot, 0 as tot_pot from public.pegawai Where satkerja = '$satkerja'  And kdbantu != 6 and left(kd_fung,1) != 'U'
			union all
			SELECT '510101050002' as kd_rek5,' Belanja Tunjangan Fungsional Umum PPPK' as nm_rek5, Sum(umum) as tot, '' as kd_rek5_pot,'' as nm_rek5_pot, 0 as tot_pot from public.pegawai Where satkerja = '$satkerja'  And kdbantu != 6 
			union all
			SELECT '510101100002' as kd_rek5,'Belanja Iuran Jaminan Kecelakaan Kerja PPPK' as nm_rek5, Sum(jkk) as tot, '210601010020' as kd_rek5_pot,'Utang Belanja Jaminan Kecelakaan Kerja ASN- Iuran Jaminan Kecelakaan Kerja PPPK' as nm_rek5_pot, sum(jkk) as tot_pot from public.pegawai Where satkerja = '$satkerja'  And kdbantu != 6
			union all
			SELECT '510101110002' as kd_rek5,'Belanja Iuran Jaminan Kematian PPPK' as nm_rek5, Sum(jkm) as tot, '210601010022' as kd_rek5_pot,'Utang Belanja Iuran Jaminan Kematian ASN- Iuran Jaminan Kematian PPPK' as nm_rek5_pot, sum(jkm) as tot_pot from public.pegawai Where satkerja = '$satkerja'  And kdbantu != 6
			union all
			SELECT '510101090002' as kd_rek5,'Belanja Iuran Jaminan Kesehatan PPPK' as nm_rek5, Sum(askes) as tot, '' as kd_rek5_pot,'' as nm_rek5_pot, 0 as tot_pot from public.pegawai Where satkerja = '$satkerja'  And kdbantu != 6
			";
			...
			if($status!='detail'){
				...
				if($ck->num_rows() == 0) {
					...
					VALUES('$nomor_sp2d','$tanggal','$nomor_spm','$tanggal','$no_spp','$kd_skpd','$nm_satkerja','$tanggal','$bln','$no_spd','$untuk','$user','$tglupdate','4',
							'$no_rekening','$npwp','$total','G','$bayar_kepada')";
