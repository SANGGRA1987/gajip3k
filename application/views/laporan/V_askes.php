<form action="<?php echo base_url()."laporan/C_Askes/askes";?>" target="_blank" id="fm" method="post" novalidate style="margin:0;padding:10px 10px" enctype="multipart/form-data">
    <div class="row">
        <div class="col-md-6">
            <div style="margin-bottom:20px">
                ...
                <div class="col-sm-12" style="padding-bottom: 20px;">
                    ...
                    <div class="col-sm-4" ><button type="submit" id="cetak" value="cetak" name="cetak" class="btn btn-default" style="width:120%;" ><i class="fa fa-file-pdf-o" ></i> CETAK PDF</button></div>
                    <div class="col-sm-4" ><button type="submit" id="cetak1" value="cetak1" name="cetak1" class="btn btn-success" style="width:120%;" ><i class="fa fa-file-excel-o" ></i> CETAK EXCELL</button></div>
