<form action="<?php echo base_url()."laporan/C_tunjangan_beras/tunjangan_beras";?>" target="_blank" id="fm" method="post" novalidate style="margin:0;padding:10px 10px" enctype="multipart/form-data">
    <div class="row">
        <div class="col-md-6">
