...
/** Jenis Cetak   => SKPD, Unit, Keseluruhan
  ...
  **/
  ...
  var jnsCetak = '';
  var urll     = "<?php echo site_url(); ?>laporan/lap_formb/C_formb/cetakLaporan";
 ...
 // var _nmskpd2 = $('#nm_skpd2');
  ...
  $(document).ready(function() { 
    ...
    $("#skpd").combogrid({
      ...
      idField:'satkerja',
      textField:'satkerja',
      url:'<?php echo base_url('laporan/lap_formb/C_formb/getSkpd') ?>',
      columns:[[
		...
		var kdskpd = row.satkerja;
            ...
            if (kdskpd != '') {
              $('#unit_skpd').combogrid({
                ...
                idField:'kd_uskpd',
                textField:'kd_uskpd',
                url:'<?php echo base_url('laporan/lap_formb/c_formb/getUnitSkpd/') ?>' + kdskpd,
                columns:[[
    ...
    function loadSelect2(){
      ...
      _bulan.select2({
        ...
        ajax: {
            url: "<?php echo base_url('laporan/lap_formb/C_formb/getBulan') ?>",
            dataType: 'json',
