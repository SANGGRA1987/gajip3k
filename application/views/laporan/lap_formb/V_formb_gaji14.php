      ...
      <div class="col-sm-10 thn_" style="padding: 10px 0px 10px 0">
        ...
        <div class="col-sm-2">
          <select id="printer" class="easyui-combobox" style="width: 200%">
			<option value="1">DAFTAR GAJI 14 P3K</option>
...
/** Jenis Cetak   => SKPD, Unit, Keseluruhan
  ...
  **/
  ...
  var jnsCetak = '';
  var urll     = "<?php echo site_url(); ?>laporan/lap_formb/C_formb_gaji14/cetakLaporan";
 ...
 // var _nmskpd2 = $('#nm_skpd2');
  ...
  $(document).ready(function() { 
    ...
    $("#skpd").combogrid({
      ...
      idField:'satkerja',
      textField:'satkerja',
      url:'<?php echo base_url('laporan/lap_formb/C_formb_gaji14/getSkpd') ?>',
      columns:[[
		...
		var kdskpd = row.satkerja;
            ...
            if (kdskpd != '') {
              $('#unit_skpd').combogrid({
                ...
                idField:'kd_uskpd',
                textField:'kd_uskpd',
                url:'<?php echo base_url('laporan/lap_formb/C_formb_gaji14/getUnitSkpd/') ?>' + kdskpd,
                columns:[[
    ...
    function loadSelect2(){
      ...
      _bulan.select2({
        ...
        ajax: {
            url: "<?php echo base_url('laporan/lap_formb/C_formb_gaji14/getBulan') ?>",
            dataType: 'json',
