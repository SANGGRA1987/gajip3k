...
/** Jenis Cetak   => SKPD, Unit, Keseluruhan
  ...
  **/
  ...
  var jnsCetak = '';
  var urll     = "<?php echo site_url(); ?>laporan/lap_rekapitulasi/C_rekap_golongan_gaji14/cetakLaporan";
 ...
 // var _nmskpd2 = $('#nm_skpd2');
  ...
  $(document).ready(function() { 
    ...
    $("#skpd").combogrid({
      ...
      idField:'satkerja',
      textField:'satkerja',
      url:'<?php echo base_url('laporan/lap_rekapitulasi/C_rekap_golongan_gaji14/getSkpd') ?>',
      columns:[[
          ...
          onSelect: function(index, row){
            ...
            if (kdskpd != '') {
              $('#unit_skpd').combogrid({
                ...
                idField:'kd_uskpd',
                textField:'kd_uskpd',
                url:'<?php echo base_url('laporan/lap_rekapitulasi/C_rekap_golongan_gaji14/getUnitSkpd/') ?>' + kdskpd,
                columns:[[
    ...
    function loadSelect2(){
      ...
      _bulan.select2({
        ...
        ajax: {
            url: "<?php echo base_url('laporan/lap_rekap_golongan/C_rekap_golongan_gaji14/getBulan') ?>",
            dataType: 'json',
