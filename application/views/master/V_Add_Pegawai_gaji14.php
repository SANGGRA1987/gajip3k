...
<script type="text/javascript">
	...
	function back() {
        localStorage.clear();
        window.location.href = "<?php echo base_url(); ?>master/C_Pegawai_gaji14";
    }
 ...
 s_pegawai2:s_pegawai2,tunj_beras:tunj_beras,s_pegawai3:s_pegawai3,pilihan:pilihan,tistri:tistri,tanak:tanak,askes:askes,jkk:jkk,jkm:jkm,status:cStatus2,tunggakan:pbb,beras:beras,iwp:iwp,tht:tht,papua:papua,pph:pph,disc:ndisc,bulat:bulat,bruto:bruto,netto:netto}, 
    ...
    $(document).ready(function() {
		...
		$('#status_kawin').combogrid({
            ...
            url:'<?php echo base_url(); ?>master/C_Pegawai_gaji14/get_statuskawin', 
            mode:'remote',
            columns:[[  
		...
		$('#k_bantu').combogrid({
            ...
            url:'<?php echo base_url(); ?>master/C_Pegawai_gaji14/get_kodebantu', 
            mode:'remote',
            columns:[[  
               {field:'kode',title:'Kode',width:70,align:'center'},  
		...
		$('#agama').combogrid({
            ...
            url:'<?php echo base_url(); ?>master/C_Pegawai_gaji14/get_agama', 
            mode:'remote',
            columns:[[  
               {field:'kode',title:'Kode',width:70,align:'center'},  
		...
		$('#satuan_kerja').combogrid({
            ...
            idField:'satkerja',  
            textField:'satkerja',  
            url:'<?php echo base_url(); ?>master/C_Pegawai_gaji14/get_satker', 
            mode:'remote',
            columns:[[  
			...
			onSelect:function(rowIndex,rowData){
			   ...
			   $("#nm_satkerja").textbox('setValue',nm_satkerja);
			   $('#unit_kerja').combogrid({url:'<?php echo base_url(); ?>master/C_Pegawai_gaji14/getUnit',
		...
		$('#gol').combogrid({
            ...
            idField:'golongan',  
            textField:'golongan',  
            url:'<?php echo base_url(); ?>master/C_Pegawai_gaji14/get_gol', 
            mode:'remote',
            columns:[[  
			...
			onSelect:function(rowIndex,rowData){
			   ...
			   $("#n_fungsional").val(0);
				...
				$("#t_struktural").combogrid("setValue",'');
				$("#t_fungsional").combogrid("setValue",''); 
			   $('#masa_kerja1').combogrid({url:'<?php echo base_url(); ?>master/C_Pegawai_gaji14/get_masakerja',
			   queryParams:({golongan:golongan}),			   
			   });
			   $('#t_fungsional').combogrid({url:'<?php echo base_url(); ?>master/C_Pegawai_gaji14/get_fungsional',
			   queryParams:({golongan:golongan}),			   
			   });
			}
        });
		...
		$('#t_struktural').combogrid({
            ...
            idField:'eselon',  
            textField:'eselon',  
            url:'<?php echo base_url(); ?>master/C_Pegawai_gaji14/get_eselon', 
            mode:'remote',
            columns:[[  
		...
		$('#t_fungsional').combogrid({
            ...
            idField:'kd_fung',  
            textField:'kd_fung',  
            url:'<?php echo base_url(); ?>master/C_Pegawai_gaji14/get_fungsional', 
            mode:'remote',
            columns:[[  
		...
		$('#t_khusus').combogrid({
            ...
            idField:'kd_khusus',  
            textField:'kd_khusus',  
            url:'<?php echo base_url(); ?>master/C_Pegawai_gaji14/get_khusus', 
            mode:'remote',
            columns:[[  
		...
		$('#batas_pensiun').combogrid({
            ...
            idField:'umur',  
            textField:'umur',  
            url:'<?php echo base_url(); ?>master/C_Pegawai_gaji14/get_pensiun', 
            mode:'remote',
            columns:[[  
		...
		$('#masa_kerja2').combogrid({
            ...
            idField:'n_bulan',  
            textField:'n_bulan',  
            url:'<?php echo base_url(); ?>master/C_Pegawai_gaji14/get_bulan', 
            mode:'remote',
            columns:[[  
