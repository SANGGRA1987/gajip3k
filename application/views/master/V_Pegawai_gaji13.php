...
<script type="text/javascript">
	...
	function newUser() {
		...
		window.location.href = '<?php echo site_url('master/C_Pegawai_gaji13/add'); ?>';
	}
	...
	function detail_gaji() {		
		...
		window.location.href = '<?php echo site_url('master/C_Pegawai_gaji13/info_gaji'); ?>';
	}
	...
	$(document).ready(function() {
		...
		$('#dg').datagrid({
			...
			fitColumns:true,
			pagination:true,
			url: '<?php echo base_url(); ?>master/C_Pegawai_gaji13/load_header',
	...
	function hapus() {
		...
		if ( row ){
			$.messager.confirm('Konfirmasi','Yakin ingin menghapus data pegawai atas nama '+nama+' ?',function(r){
				if (r){
					$.post('<?php echo base_url(); ?>master/C_Pegawai_gaji13/hapus',
