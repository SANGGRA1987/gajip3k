...
<script type="text/javascript">  
  ...
  var urll     = "<?php echo site_url(); ?>utilitas/C_Kartu/proses";
  var _bulan = $('#bulan');
  ...
  $('#bulan').combogrid({
            ...
            mode:'remote',
            url:'<?php echo base_url(); ?>utilitas/C_Kartu/getBulan',  
            columns:[[  
    ...
    $('#proses').click(function(){
		...
		$.messager.confirm('Konfirmasi','Yakin ingin melakukan proses kartu gaji ???',function(r){
			if (r){
