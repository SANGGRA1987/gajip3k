...
<script type="text/javascript">  
  ...
  var urll     = "<?php echo site_url(); ?>utilitas/C_Kartu_gaji13/proses";
  var _bulan = $('#bulan');
  ...
  $('#bulan').combogrid({
            ...
            mode:'remote',
            url:'<?php echo base_url(); ?>utilitas/C_Kartu_gaji13/getBulan',  
            columns:[[  
    ...
    $('#proses').click(function(){
		...
		$.messager.confirm('Konfirmasi','Yakin ingin melakukan proses kartu gaji 13???',function(r){
			if (r){
