...
<script type="text/javascript">  
  ...
  var urll     = "<?php echo site_url(); ?>utilitas/C_Proses_gaji14/proses";
  var _bulan = $('#bulan');
  ...
  $('#bulan').combogrid({
            ...
            mode:'remote',
            url:'<?php echo base_url(); ?>utilitas/C_Proses_gaji14/getBulan',  
            columns:[[  
    ...
    $('#proses').click(function(){
		...
		$.messager.confirm('Konfirmasi','Yakin ingin melakukan proses gaji 14???',function(r){
			if (r){
