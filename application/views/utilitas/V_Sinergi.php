<div class="tab-content" id="myTabContent">
	<div class="col-sm-12" style="padding-bottom: 10px;">
		...
		<div class="col-sm-3">
			<button type="button" class="btn btn-success" style="width: 150px" id="proses" ><b> PROSES REKAP </b></button>
		</div>
		<div class="col-sm-3">
			<button type="button" class="btn btn-success" style="width: 150px" id="proses2" ><b> PROSES DETAIL </b></button>
		</div>
	</div>
	<!--<div class="col-sm-12" style="padding-bottom: 10px;">
...
<script type="text/javascript">  
  ...
  var urll     = "<?php echo site_url(); ?>utilitas/C_Sinergi/proses";
  var urll2    = "<?php echo site_url(); ?>utilitas/C_Sinergi/proses2";
  var _bulan = $('#bulan');
  ...
  $('#bulan').combogrid({
            ...
            mode:'remote',
            url:'<?php echo base_url(); ?>utilitas/C_Sinergi/getBulan',  
            columns:[[  
    ...
    $('#proses').click(function(){
		...
		$.messager.confirm('Konfirmasi','Yakin ingin melakukan proses data REKAP ADK SINERGI???',function(r){
			if (r){
	...
	$('#proses2').click(function(){
		var xbulan  	= $('#bulan').val();
		$.messager.confirm('Konfirmasi','Yakin ingin melakukan proses data DETAIL ADK SINERGI???',function(r){
			if (r){
			lc = '?bulan='+_bulan.combogrid('getValue');
